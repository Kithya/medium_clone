 <a href="{{ route('post.show', ['username' => $post->user->username, 'post' => $post->slug]) }}"
     ...
     <div class="flex flex-col justify-between md:p-4 leading-normal">
         ...
         <div class="text-sm text-gray-400 flex items-center gap-2">
             ...
             <span class="flex items-center opacity-50 mt-[-3px]">
                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                     aria-label="clap"
                     class="transition-transform duration-200 ease-out group-hover:-translate-y-0.5 group-hover:scale-110 group-active:translate-y-0 group-active:scale-95 mr-[0.7px]">
