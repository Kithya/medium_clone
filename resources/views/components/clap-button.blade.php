...
"
        class="border-b p-4 mt-6 border-t">
        <button @click="clap()"
            class="group flex items-center gap-1 text-gray-500 transition-colors duration-200 hover:text-purple-600 active:text-purple-700">
