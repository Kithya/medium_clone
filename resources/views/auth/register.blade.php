<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            <x-text-input id="email" class="mt-2 block w-full" type="email" name="email" :value="old('email')" required autocomplete="email" />
        ...
        <p class="text-center text-sm text-neutral-600">
            ...
            <a href="{{ route('login') }}" class="font-medium text-neutral-950 hover:underline">{{ __('Sign in') }}</a>
        </p>
    </form>
</x-guest-layout>
